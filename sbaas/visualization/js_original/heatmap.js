heatmap_d3 = function (data_I, chart_I) {
    ...
    var options = data_I.options; //domain:'1' = normalized in domain [-10,10]; domain:2 = normalized in domain [0,1]
    ...
    } //use for expression data (domain -10.0-10.0)
    else if (options.domain == '2') {
        var colorBuckets = 10;
    ...
    } //specific to resequencing data (domain 0.0-1.0)
